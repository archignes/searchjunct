...
import ViewMultisearchSheet from '@/components/search/multisearch/ViewMultisearchSheet';
            ...
            <Card className='rounded-md bg-white shadow-none mx-auto'>
                ...
                <CardContent className="p-0 flex items-left flex-col">
                    ...
                    {multisearchActionObjects.map((shortcut: MultisearchActionObject, index) => (
                        <div className="grid grid-cols-6 px-3 my-1">
                        <Button className="w-2/3 col-span-2" variant="outline" size="sm" key={index} onClick={() => {
